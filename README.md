...
## Features
- Web service interaction: interacts with external web service (Wikipedia API) for finding short description of artists.
- SSML (Speech Synthesis Markup Language): use of SSML tags to control how Alexa renders text-to-speech
...
4. Name the Lambda Function "Music-Buff-Example-Skill".
